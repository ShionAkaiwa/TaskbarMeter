...
- **ドット絵キャラ** — 負荷で 5 段階に変わる（うとうと / ふつう / ごきげん / あせり / 限界）。表情だけでなく体の高さも変わるので、16px でも段階が読めます＋まばたき
...
ゲージは上下 2 段を別々に使って 28 段階あり、真ん中に 50% の目印が入ります。
...
個人が趣味で作ったものなので、使ったことで何か起きても責任は取れません。
そこだけ了承のうえで使ってください。
